...
- vemos que en este caso es parecido al anterior, lo que nos dice es que en este caso los datos se encuentran en ascci
- se espera que metamos lo siguiente 
```
