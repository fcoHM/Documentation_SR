...
## Solución
- se nos da un archivo png el cual si se abre no hay nada
- si revisamos hay rutas de carpeta 
```
secret/UT
secret/flag.pngUT
```

- usando binwalk vemos que efectivamente hay una ruta de un comprimido dentro de este archivo png
```
...
extraemos todo lo que hay en el png original con la opcion -e y buscamos entre los contenidos y encontramos un png con la flag
```
